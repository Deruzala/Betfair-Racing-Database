...
:setvar DefaultDataPath "C:\Users\aaron\AppData\Local\Microsoft\VisualStudio\SSDT\"
:setvar DefaultLogPath "C:\Users\aaron\AppData\Local\Microsoft\VisualStudio\SSDT\"
...
GO
ALTER TABLE [dbo].[OtherPlace] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[PlacePrice] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[RaceCard] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[OtherPlace] WITH CHECK CHECK CONSTRAINT [FK_OtherPlace_Racecard];

ALTER TABLE [dbo].[PlacePrice] WITH CHECK CHECK CONSTRAINT [FK_PlacePrice_RaceCard];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_country];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_course];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_distance];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_going];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_headgear];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_horse];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_jockey];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_trainer];

ALTER TABLE [dbo].[RaceCard] WITH CHECK CHECK CONSTRAINT [FK_RaceCard_racetype];

ALTER TABLE [dbo].[Records] WITH CHECK CHECK CONSTRAINT [FK_Records_bid];

ALTER TABLE [dbo].[Records] WITH CHECK CHECK CONSTRAINT [FK_Records_outcome];

ALTER TABLE [dbo].[Records] WITH CHECK CHECK CONSTRAINT [FK_Records_Racecard];

ALTER TABLE [dbo].[Records] WITH CHECK CHECK CONSTRAINT [FK_Records_system];
