...
-- Description:	
	...
	/* 		returns the equivalent in pounds of a weight expressed as string of the form SS-PP
...
CREATE FUNCTION [dbo].[fn_ConvertStringStonesAndPoundsToLbs](@intStr nvarchar(300)) RETURNS float
BEGIN
